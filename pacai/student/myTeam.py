...
def createTeam(firstIndex, secondIndex, isRed,
    ...
    # firstAgent = DefenseAgentDQN(firstIndex, weights=weights65, numTraining=200, alpha=0.00001, epsilon=0, update_frequency=2000)
    firstAgent = DefenseAgentDQN(firstIndex, weights=weights65, numTraining=0, alpha=0, epsilon=0)
    secondAgent = DefenseAgentDQN(secondIndex, weights=weights64, numTraining=0, alpha=0, epsilon=0)
